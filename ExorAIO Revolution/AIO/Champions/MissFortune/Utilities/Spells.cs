...
namespace AIO.Champions
{
    ...
    internal partial class MissFortune
    {
        ...
        public void Spells()
        {
            SpellClass.Q = new Spell(SpellSlot.Q, UtilityClass.Player.AttackRange);
            ...
            SpellClass.Q2.SetSkillshot(0.25f, UtilityClass.GetAngleByDegrees(160), 1000f, false, SkillshotType.Line);
