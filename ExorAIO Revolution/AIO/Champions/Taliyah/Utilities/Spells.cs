namespace AIO.Champions
{
    ...
    internal partial class Taliyah
    {
        ...
        public void Spells()
        {
            ...
            SpellClass.Q.SetSkillshot(0.275f, 100f, 3600f, false, SkillshotType.Line, false, HitChance.Low);
            SpellClass.W.SetSkillshot(1.25f, 200f, float.MaxValue, false, SkillshotType.Circle, true);
            SpellClass.E.SetSkillshot(0.30f, UtilityClass.GetAngleByDegrees(80f), float.MaxValue, false, SkillshotType.Cone, false, HitChance.None);
        }
