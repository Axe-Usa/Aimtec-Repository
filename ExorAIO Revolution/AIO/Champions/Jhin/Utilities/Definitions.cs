...
namespace AIO.Champions
{
    ...
    internal partial class Jhin
    {
        ...
        {
            return new Geometry.Sector(GameObjects.Player.Position.Extend(this.End, -GameObjects.Player.BoundingRadius * 3), this.End, UtilityClass.GetAngleByDegrees(55f), SpellClass.R.Range);
        }
