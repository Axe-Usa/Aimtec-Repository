...
namespace AIO.Champions
{
    ...
    internal partial class Syndra
    {
        ...
        public void Spells()
        {
            ...
            SpellClass.Q.SetSkillshot(0.50f, 60f, float.MaxValue, false, SkillshotType.Circle, false, HitChance.None);
            SpellClass.W.SetSkillshot(0.45f, 40f, 2000f, false, SkillshotType.Circle, false, HitChance.None);
