namespace AIO.Champions
{
    ...
    internal partial class Jinx
    {
        ...
        public void Spells()
        {
            ...
            SpellClass.W.SetSkillshot(0.6f, 85f, 3200f, true, SkillshotType.Line, false, HitChance.Medium);
            SpellClass.E.SetSkillshot(1f, 100f, 1000f, false, SkillshotType.Circle);
            SpellClass.R.SetSkillshot(0.6f, 140f, 1700f, false, SkillshotType.Line, false, HitChance.None);
        }
