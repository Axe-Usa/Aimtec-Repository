namespace AIO.Champions
{
    ...
    internal partial class Jinx
    {
        ...
        public void Spells()
        {
            ...
            SpellClass.W.SetSkillshot(0.6f, 85f, 3200f, true, SkillType.Line);
            SpellClass.E.SetSkillshot(1f, 100f, 1000f, false, SkillType.Circle);
            SpellClass.R.SetSkillshot(0.6f, 140f, 1700f, false, SkillType.Line);
        }
